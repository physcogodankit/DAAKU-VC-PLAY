...
OWNER_NAME = getenv("OWNER_NAME", "DAAKU")
OWNER_USERNAME = getenv("OWNER_USERNAME", "THEANONYMOUS_USER")
ALIVE_NAME = getenv("ALIVE_NAME", "Zaid")
BOT_USERNAME = getenv("BOT_USERNAME", "Zaid2_Robot")
OWNER_ID = getenv("OWNER_ID", "5708043833")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Zaid2_Assistant")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "DAAKU_FIGHTER")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "DAYWITHMECLUB")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/physcogodankit/DAAKU-Vc-Play")
